...
Проект прошёл функциональное и пользовательское тестирование:
План и результаты тестирования — в папке [`testing/`](./testing/)
  - [`test_plan.md`](./testing/test_plan.md) — цель и методы
  - [`test_report.md`](./testing/test_report.md) — таблица тест-кейсов
  - [`issues.md`](./testing/issues.md) — найденные баги и предложения
  - 
  Обратная связь от пользователей 
  Проведён опрос 5 одногруппников. Ключевые выводы:
  -  Интерфейс в целом понятен  
  -  Требуется улучшить кликабельность карточек и защиту от пустых изображений  
  -  Подробный анализ — в [`feedback_summary.md`](./testing/feedback_summary.md)
